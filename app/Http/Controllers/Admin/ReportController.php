...
foreach ($leadsByCampaign as $campaignId => $leads) {
    ...
    // Create the label for the campaign including the lead count
...
$funnelSettings = [
    ...
    // Function to fetch data for each funnel section

// Function to fetch data for each funnel stage
...
foreach ($funnelSettings as $settings) {
    ...
    $percentage = $totalLeads > 0 ? ($count / $totalLeads) * 100 : 0; // Calculate percentage
