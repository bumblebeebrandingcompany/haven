                                ...
                                <div class="{{ $settings9['column_class'] }}">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number">{{ number_format($settings9['total_number']) }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="{{ $settings8['column_class'] }}">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number">{{ number_format($settings8['total_number']) }}</span>
                                        </div>
                                        <!-- /.info-box-content -->
                                    </div>
                                    <!-- /.info-box -->
                                ...
                                <div class="{{ $settings7['column_class'] }}">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number">{{ number_format($settings7['total_number']) }}</span>
                                        </div>
                                        <!-- /.info-box-content -->
                                    </div>
                                    <!-- /.info-box -->
