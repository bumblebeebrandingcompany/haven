                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="project_id" id="project_id" class="form-control {{ $errors->has('project_id') ? 'is-invalid' : '' }}" readonly disabled>
...
<div class="row info_section sell_do_and_lead_info">
    @includeIf('admin.bookings.partials.sell_do_and_lead_info')
</div>
                ...
                <div id="basic_details_of_co_applicant_accordion_collapse" class="collapse" data-parent="#basic_details_of_co_applicant_accordion">
                    <div class="card-body">
                        ...
                        <div class="row basic_common_details_of_co_applicant">
                            @includeIf('admin.bookings.partials.basic_common_details_of_co_applicant')
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Booking_Application_Date[Application_date]" id="Application_date" class="form-control application_date" readonly value="{{$Booking_Application_Date['Application_date'] ?? ''}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Booking_Application_Date[Application_time]" id="Application_time" class="form-control application_time" readonly value="{{$Booking_Application_Date['Application_time'] ?? ''}}">
                        </div>
                    </div>
                </div>
            </div>
