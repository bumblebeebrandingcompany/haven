                                ...
                                <form action="{{ route('admin.update.email.and.phone.key') }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($source->project->system_fields?? '')
                                            ...
                                            @endforeach
                                        @endif
                                        @if ($source->project->sell_do_fields?? '')
                                            @foreach ($source->project->sell_do_fields as $key => $sellDoField)
                                        ...
                                        @if ($source->project->custom_fields?? '')
                                            ...
                                            @endforeach
                                        @endif
                                        @if ($source->project->inbox_fields?? '')
                                        @foreach ($source->project->inbox_fields as $key => $inboxFields)
