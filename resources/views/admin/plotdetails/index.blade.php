        ...
        @if (!auth()->user()->is_client)
            <div class="card-header">
                ...
                @include('csvImport.modal', [
                    'model' => 'PlotDetail',
                    'route' => 'admin.plotdetails.parseCsvImport',
                ])
            </div>  
        @endif
        <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between flex-nowrap">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <a href="{{ route('admin.plotdetails.show', $plotdetails->id) }}" class="btn btn-primary btn-sm">
                                                View
                                            </a>
                                        </div>
                                    </div>
                                    @if (!auth()->user()->is_client)
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <a href="{{ route('admin.plotdetails.edit', $plotdetails->id) }}" class="btn btn-info btn-sm">
                                                    Edit
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal_{{ $plotdetails->id }}">
                                                    Delete
                                                </button>
                                                <!-- Delete Confirmation Modal -->
                                                <div class="modal fade" id="deleteModal_{{ $plotdetails->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel_{{ $plotdetails->id }}" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="deleteModalLabel_{{ $plotdetails->id }}">Confirm Deletion</h5>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('admin.plotdetails.destroy', $plotdetails->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
...
@include('admin.plotdetails.create')