    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endif
                @if (auth()->user()->checkPermission('document_view') || auth()->user()->checkPermission('document_send'))
                    <li
                ...
                @endif
                @if (auth()->user()->checkPermission('user_view') || auth()->user()->checkPermission('audit_log_view'))
                    <li
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @if (auth()->user()->checkPermission('user_view'))
                            <li class="nav-item">
                                <a href="{{ route('admin.selldoUser.index') }}"
                                    class="nav-link {{ request()->is('admin/selldoUser') || request()->is('admin/selldoUser') ? 'active' : '' }}">
                ...
                {{-- @if (auth()->user()->checkPermission('lead_view')) --}}
                    <li class="nav-item">
                        <a href="{{ route('admin.leads.index') }}" id="lead_menu_link"
                ...
                @if (auth()->user()->checkPermission('project_view'))
                    <li class="nav-item">
                        <a href="{{ route('admin.selldo.index') }}"
                            class="nav-link {{ request()->is('admin/selldo') || request()->is('admin/selldo/*') ? 'active' : '' }}">
                            <i class="fa-fw nav-icon fas fa-project-diagram">
